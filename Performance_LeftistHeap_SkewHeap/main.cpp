...
int main(int argc, char* argv[]){
    ...
    for(int s = 0; s < 4; s++){
      ...
      for(int i = 1; i<= 5; i++){
        ...
        write << "Leftist Heap build duration #" << i << ": " << duration << " seconds\n";

        Skew_Heap *my_heap = new Skew_Heap();
        srand(i);
        ...
        duration = my_timer.stop();
        write << "Skew-Heap build duration #" << i << ": " << duration << " seconds\n";
        ...
        operation(n, lh);
        duration = my_timer.stop();
        write << "Leftist Heap operation duration #" << i << ": " << duration << " seconds\n";

        srand(i);
        my_timer.start();
        operation(n, my_heap);
        duration = my_timer.stop();
        write << "Skew-Heap operation duration #" << i << ": " << duration << " seconds\n";
